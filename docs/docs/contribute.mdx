...
> If you want to ask a question, we assume that you have read the available [Documentation](https://github.com/coderevivehq/selectize.js/tree/master/docs).

Before you ask a question, it is best to search for existing [Issues](https://github.com/coderevivehq/selectize.js/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/coderevivehq/selectize.js/issues/new).
...
- Determine if your bug is a bug and not an error. e.g., using incompatible environment components/versions (Make sure that you have read the [documentation](https://github.com/coderevivehq/selectize.js/tree/master/docs). If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/coderevivehq/selectize.js/issues?q=label%3Abug).
...
> You must never report security-related issues, vulnerabilities, or bugs including sensitive information to the issue tracker or elsewhere in public. Follow the [security policy](https://github.com/coderevivehq/selectize.js/security/policy) for private reports.

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/coderevivehq/selectize.js/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/coderevivehq/selectize.js/tree/master/docs) carefully and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/coderevivehq/selectize.js/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project. It's up to you to make a strong case to convince the project's developers of the merits of this feature. Keep in mind that we want features that will be useful to the majority of our users and not just a small subset. If you're just targeting a minority of users, consider writing an add-on/plugin library.

#### How Do I Submit a Good Enhancement Suggestion?

We track enhancement suggestions as [GitHub issues](https://github.com/coderevivehq/selectize.js/issues).
...
Install dependencies, build the project, and run the test suite with:
...
To build the documentation locally after building the library:

```bash
npm run docs
```

To specify one or more specific browsers when testing:
...
- **Do not make changes to generated files in `/dist` or `/docs/static/js`.** Limiting your edits to files in `/src` directories keeps the size of your pull request down and makes it easier for us to evaluate.
